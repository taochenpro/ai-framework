...
- Test strategy updates in `docs/testing-strategy.md`.
- Unit, integration, end-to-end, contract, or regression tests under `tests/`.
- Test case notes using `tests/test-case-template.md` when useful.

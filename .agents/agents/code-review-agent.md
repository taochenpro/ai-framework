...
- Relevant task records from `.agents/memory/tasks.yaml`.
...
- Feedback patterns for `.agents/memory/evolution-log.md` when repeated issues appear.
...
- Send recurring process failures to the Project Coordinator Agent and `.agents/meta/` feedback loop.

...
- Existing `.agents/docs/requirements.md`.
- Relevant decisions in `.agents/memory/decisions/`.
- User, customer, compliance, budget, timeline, and platform constraints.

## Outputs

- Updated `.agents/docs/requirements.md`.
- User stories or job stories with acceptance criteria.
- Non-functional requirements and constraints.
- Candidate tasks for `.agents/memory/tasks.yaml`.
...
- Update `.agents/memory/tasks.yaml` only with proposed tasks unless coordinating ownership explicitly.

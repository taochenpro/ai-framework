...
- Existing `.agents/docs/architecture.md`.
- Current code structure under `.agents/src/`.
- Decisions under `.agents/memory/decisions/`.
- Operational and deployment constraints from the DevOps Agent.

## Outputs

- Updated `.agents/docs/architecture.md`.
- Architecture decision records in `.agents/memory/decisions/`.
